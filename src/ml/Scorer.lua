...
--- Constructor.
-- 
-- @arg {string=} gold_log - if given, gold labels will be written to this file
-- @arg {string]} pred_log - if given, predicted labels will be written to this file
...
-- @arg {string} gold - ground truth label
-- @arg {string} pred - corresponding predicted label
-- @arg {string=} id - corresponding identifier for this example
-- 
...
-- @arg {string=} ignore - if given, `ignore` is taken to be the "negative" class and its statistics will be withheld
-- from the computation.
-- @returns {table, table, table} micro, macro, and class scores
-- 
-- Example:
-- 
-- @code
